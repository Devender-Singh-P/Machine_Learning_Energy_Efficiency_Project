...
from energy_efficiency.logger import logging, get_log_file_name
from energy_efficiency.exception import energy_efficiencyException
from threading import Thread
from typing import List

from multiprocessing import Process
from energy_efficiency.entity.artifact_entity import ModelPusherArtifact, DataIngestionArtifact, ModelEvaluationArtifact
from energy_efficiency.entity.artifact_entity import DataValidationArtifact, DataTransformationArtifact, ModelTrainerArtifact
from energy_efficiency.entity.config_entity import DataIngestionConfig, ModelEvaluationConfig
...
from energy_efficiency.component.model_trainer import ModelTrainer
from energy_efficiency.component.model_evaluation import ModelEvaluation
from energy_efficiency.component.model_pusher import ModelPusher
import os, sys
from collections import namedtuple
from datetime import datetime
import pandas as pd
...
class Pipeline(Thread):
    ...
    @classmethod
    def get_experiments_status(cls, limit: float = 5) -> pd.DataFrame:
        try:
            if os.path.exists(Pipeline.experiment_file_path):
